...
md"""# Augustine, *Confessions*: token frequencies"""
...
srcfile = joinpath(pwd() |> dirname, "src", "confessions.cex")
...
- citable passages: **$(length(corpus))** 
- lexical tokens ("words"): **$(length(lex))**
- distinct tokens (forms): **$(length(counts))**
...
manifest_format = "2.0"
project_hash = "2b06c18968f0b2f8533bfff80f76dcb5baf17a0e"
